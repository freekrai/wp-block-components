...
import { withKnobs, boolean, select, text, color, number } from '@storybook/addon-knobs';
...
`;
storiesOf('CoreParagraphBlock', module).addDecorator(withKnobs).add('Default', () => React.createElement(CoreParagraphBlock, {
  attributes: {
    ...
    fontSize: select('fontSize', ['small', 'normal', 'medium', 'large', 'huge'], 'normal', group),
