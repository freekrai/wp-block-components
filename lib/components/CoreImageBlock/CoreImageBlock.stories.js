...
const group = 'Props';
storiesOf('CoreImageBlock', module).addDecorator(withKnobs).add('Default', () => React.createElement(CoreImageBlock, {
  attributes: {
    align: select('align', ['left', 'center', 'right', 'wide', 'full', null], null, group),
