...
storiesOf('CoreCodeBlock', module).addDecorator(withKnobs).add('Default', () => React.createElement(CoreCodeBlock, {
  attributes: {
    className: text('className', '', group),
    content: text('content', '<p>This is the <strong>best</strong> code ever written!</p>', group),
